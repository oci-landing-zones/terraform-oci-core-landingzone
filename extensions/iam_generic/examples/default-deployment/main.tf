...
#---------------------------------------
  ...
  parent_compartment_ocid = "<REPLACE-WITH-PARENT-COMPARTMENT-OCID>"     # The ocid of the parent compartment of the Landing Zone deployed
  ...
  network_compartment_ocid = "<REPLACE-WITH-NETWORK-COMPARTMENT-OCID>"   # This value is required if isolate_workload = false. Ensure that the selected network compartment is within the selected parent compartment.
  security_compartment_ocid = "<REPLACE-WITH-SECURITY-COMPARTMENT-OCID>" # Ensure that the selected security compartment is within the selected parent compartment.
}