  ...
  oke_vcn_1 = local.add_oke_vcn1 == true ? {
    "OKE-VCN-1" = {
      ...
      subnets = merge(
        ...
        var.add_oke_vcn1_db_subnet ? {
          "OKE-VCN-1-DB-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_db_subnet_security_list != null && var.add_oke_vcn1_db_subnet && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-DB-SUBNET-SL"] : ["OKE-VCN-1-DB-SUBNET-SL"]
          }
        } : {},
      ...
      security_lists = merge(
        ...
        local.oke_vcn1_db_subnet_security_list != null && var.add_oke_vcn1_db_subnet && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-DB-SUBNET-SL" = local.oke_vcn1_db_subnet_security_list
        } : {}
      )
