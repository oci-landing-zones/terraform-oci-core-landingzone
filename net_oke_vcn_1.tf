...
locals {
  ...
  oke_vcn_1 = local.add_oke_vcn1 == true ? {
    "OKE-VCN-1" = {
      enable_cis_checks                = local.oke_vcn1_cis_checks_enabled
      ...
      subnets = merge(
        {
          "OKE-VCN-1-API-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_api_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-API-SUBNET-SL"] : []
          }
        },
        {
          "OKE-VCN-1-WORKERS-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_workers_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-WORKERS-SUBNET-SL"] : ["OKE-VCN-1-WORKERS-SUBNET-SL"]
          }
        },
        {
          "OKE-VCN-1-SERVICES-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_services_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-SERVICES-SUBNET-SL"] : ["OKE-VCN-1-SERVICES-SUBNET-SL"]
          }
        },
        var.add_oke_vcn1_mgmt_subnet ? {
          "OKE-VCN-1-MGMT-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_mgmt_subnet_security_list != null && var.add_oke_vcn1_mgmt_subnet && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-MGMT-SUBNET-SL"] : ["OKE-VCN-1-MGMT-SUBNET-SL"]
          }
        } : {},
        upper(var.oke_vcn1_cni_type) == "NATIVE" ? {
          "OKE-VCN-1-PODS-SUBNET" = {
            ...
            security_list_keys        = local.oke_vcn1_pods_subnet_security_list != null && upper(var.oke_vcn1_cni_type) == "NATIVE" && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? ["CUSTOM-OKE-VCN-1-PODS-SUBNET-SL"] : ["OKE-VCN-1-PODS-SUBNET-SL"]
          }
        } : {}
      )
      ...
      security_lists = merge(
        local.oke_vcn1_api_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-API-SUBNET-SL" = local.oke_vcn1_api_subnet_security_list
        } : {},
        {
          ...
          "OKE-VCN-1-MGMT-SUBNET-SL" = {
            ...
            egress_rules = [
              ...
              },
              {
                ...
                stateless    = false
                protocol     = "TCP"
                dst          = local.oke_vcn1_api_subnet_cidr
                dst_type     = "CIDR_BLOCK"
                dst_port_min = 6443
                dst_port_max = 6443
              },
        ...
        local.oke_vcn1_workers_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-WORKERS-SUBNET-SL" = local.oke_vcn1_workers_subnet_security_list
        } : {},
        local.oke_vcn1_services_subnet_security_list != null && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-SERVICES-SUBNET-SL" = local.oke_vcn1_services_subnet_security_list
        } : {},
        local.oke_vcn1_mgmt_subnet_security_list != null && var.add_oke_vcn1_mgmt_subnet && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-MGMT-SUBNET-SL" = local.oke_vcn1_mgmt_subnet_security_list
        } : {},
        local.oke_vcn1_pods_subnet_security_list != null && upper(var.oke_vcn1_cni_type) == "NATIVE" && (local.hub_with_vcn == true && var.oke_vcn1_attach_to_drg == true) ? {
          "CUSTOM-OKE-VCN-1-PODS-SUBNET-SL" = local.oke_vcn1_pods_subnet_security_list
        } : {}
      )
      ...
      network_security_groups = merge(
        {
          "OKE-VCN-1-API-NSG" = {
            ...
            egress_rules = merge(
              {
                "EGRESS-TO-SERVICES-API-RULE" = {
                  description = "Egress from OKE control plane to OCI services"
                  stateless   = false
                  protocol    = "TCP"
                  dst         = "all-services"
              ...
              },
              {
                "EGRESS-TO-KUBELET-API-RULE" = {
                  description  = "Egress from OKE control plane to Kubelet on worker nodes."
                  stateless    = false
                  protocol     = "TCP"
              ...
              },
              {
                "EGRESS-TO-WORKERS-API-RULE" = {
                  description  = "Egress from OKE control plane to worker node"
                  stateless    = false
                  protocol     = "TCP"
                  dst          = "OKE-VCN-1-WORKERS-NSG"
                  dst_type     = "NETWORK_SECURITY_GROUP"
              ...
              upper(var.oke_vcn1_cni_type) == "NATIVE" ? {
                "EGRESS-TO-API-API-RULE" = {
                  description  = "Egress for Kubernetes control plane inter-communication"
                  stateless    = false
                  protocol     = "TCP"
            ...
            ingress_rules = merge(
              ...
              upper(var.oke_vcn1_cni_type) == "FLANNEL" && var.add_oke_vcn1_mgmt_subnet ? {
          ...
          "OKE-VCN-1-PODS-NSG" = {
            ...
            egress_rules = merge({
              ...
              "EGRESS-TO-SERVICES-TCP-RULE" = {
                description = "Egress from pods to OCI Services."
                stateless   = false
                protocol    = "TCP"
                dst         = "all-services"
                dst_type    = "SERVICE_CIDR_BLOCK"
              ...
              "EGRESS-TO-API-RULE" = {
                description  = "Egress from pods to Kubernetes API server."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-API-NSG"
                dst_type     = "NETWORK_SECURITY_GROUP"
              ...
              "EGRESS-TO-API-12250-RULE" = {
                description  = "Egress from pods to OKE control plane."
                stateless    = false
                protocol     = "TCP"
                dst          = "OKE-VCN-1-API-NSG"
                dst_type     = "NETWORK_SECURITY_GROUP"
        ...
        local.oke_vcn1_additional_nsgs
      )
  ...
  ## Cross VCN Egress Rules from OKE_VCN_1
  ...
  oke_vcn_1_to_services_subnet_cross_vcn_egress = merge(
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-2")))) ? { for port in var.oke_vcn2_services_ingress_destination_ports : "EGRESS-TO-OKE-VCN2-ON-${port}-RULE" => {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-3")))) ? { for port in var.oke_vcn3_services_ingress_destination_ports : "EGRESS-TO-OKE-VCN3-ON-${port}-RULE" => {
  ...
  oke_vcn_1_to_pods_subnet_cross_vcn_egress = merge(
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) && (upper(var.oke_vcn2_cni_type) == "NATIVE") &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-2")))) ? {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) && (upper(var.oke_vcn3_cni_type) == "NATIVE") &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-3")))) ? {
  ...
  oke_vcn_1_to_client_subnet_cross_vcn_egress = merge(
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "EXA-VCN-1")))) ? { for port in var.exa_vcn1_client_ingress_destination_ports : "EGRESS-TO-EXA-VCN1-ON-${port}-RULE" => {
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "EXA-VCN-2")))) ? { for port in var.exa_vcn2_client_ingress_destination_ports : "EGRESS-TO-EXA-VCN2-ON-${port}-RULE" => {
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "EXA-VCN-3")))) ? { for port in var.exa_vcn3_client_ingress_destination_ports : "EGRESS-TO-EXA-VCN3-ON-${port}-RULE" => {
  ...
  oke_vcn_1_to_web_subnet_cross_vcn_egress = merge(
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-1")))) ? { for port in var.tt_vcn1_web_ingress_destination_ports : "EGRESS-TO-TT-VCN1-ON-${port}-RULE" => {
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-2")))) ? { for port in var.tt_vcn2_web_ingress_destination_ports : "EGRESS-TO-TT-VCN2-ON-${port}-RULE" => {
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-3")))) ? { for port in var.tt_vcn3_web_ingress_destination_ports : "EGRESS-TO-TT-VCN3-ON-${port}-RULE" => {
  ...
  ## Ingress rules
  ### Cross VCN ingress rules to OKE-VCN-1 Services subnet
  oke_vcn_1_to_services_subnet_cross_vcn_ingress = merge(
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-2")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "INGRESS-FROM-OKE-VCN2-ON-${port}-RULE" => {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "OKE-VCN-3")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "INGRESS-FROM-OKE-VCN3-ON-${port}-RULE" => {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-1")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "INGRESS-FROM-TT-VCN1-ON-${port}-RULE" => {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-2")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "INGRESS-FROM-TT-VCN2-ON-${port}-RULE" => {
    ...
    (local.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) &&
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "TT-VCN-3")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "INGRESS-FROM-TT-VCN3-ON-${port}-RULE" => {
    ...
    (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? { for cidr_port_pair in flatten([for cidr in var.allowed_onprem_cidrs_to_app_endpoints : [for port in var.oke_vcn1_services_ingress_destination_ports : "${trimspace(cidr)},${trimspace(port)}" ] if length(var.allowed_onprem_cidrs_to_app_endpoints) > 0 && length(var.oke_vcn1_services_ingress_destination_ports) > 0]) : "INGRESS-FROM-${split(",",cidr_port_pair)[0]}-ON-${split(",",cidr_port_pair)[1]}-RULE" => {
  ...
  ### Cross VCN ingress rules to OKE-VCN-1 Workers subnet
  ...
  ### Cross VCN ingress rules to OKE-VCN-1 Pods subnet
