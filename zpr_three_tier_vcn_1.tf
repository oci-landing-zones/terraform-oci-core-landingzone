locals {
  ...
  tt_1_to_tt_2_policies = var.add_tt_vcn2 ? [
  ...
  tt_1_to_tt_3_policies = var.add_tt_vcn3 ? [
  ...
  tt_1_to_exa_1_policies = var.add_exa_vcn1 ? [
  ...
  tt_1_to_exa_2_policies = var.add_exa_vcn2 ? [
  ...
  tt_1_to_exa_3_policies = var.add_exa_vcn3 ? [
