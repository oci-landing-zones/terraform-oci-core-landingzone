locals {
  ...
  tt_1_to_tt_2_policies = (var.add_tt_vcn1 && var.add_tt_vcn2 && var.tt_vcn1_attach_to_drg && var.tt_vcn2_attach_to_drg) &&
  ...
  tt_1_to_tt_3_policies = (var.add_tt_vcn1 && var.add_tt_vcn3 && var.tt_vcn1_attach_to_drg && var.tt_vcn3_attach_to_drg) &&
  ...
  tt_1_to_exa_1_policies = (var.add_tt_vcn1 && var.add_exa_vcn1 && var.tt_vcn1_attach_to_drg && var.exa_vcn1_attach_to_drg) &&
  ...
  tt_1_to_exa_2_policies = (var.add_tt_vcn1 && var.add_exa_vcn2 && var.tt_vcn1_attach_to_drg && var.exa_vcn2_attach_to_drg) &&
  ...
  tt_1_to_exa_3_policies = (var.add_tt_vcn1 && var.add_exa_vcn3 && var.tt_vcn1_attach_to_drg && var.exa_vcn3_attach_to_drg) &&
