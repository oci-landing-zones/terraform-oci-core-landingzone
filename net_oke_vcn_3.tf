...
locals {
  ...
  oke_vcn3_external_allowed_cidrs_to_ports_into_services_tier = local.add_oke_vcn3 == true ? flatten([for cidr in var.oke_vcn3_external_allowed_cidrs_into_services_tier : [for port in var.oke_vcn3_services_ingress_destination_ports : "${trimspace(cidr)},${trimspace(port)}" ]]) : []
      ...
      network_security_groups = merge(
        ...
        {  
          "OKE-VCN-3-SERVICES-NSG" = {
            ...
            ingress_rules = { for cidr_port_pair in local.oke_vcn3_external_allowed_cidrs_to_ports_into_services_tier : "INGRESS-FROM-${replace(replace(split(",",cidr_port_pair)[0], ".", ""), "/", "")}-ON-${split(",",cidr_port_pair)[1]}-RULE" => {
  ...
  oke_vcn_3_to_services_subnet_cross_vcn_egress = merge(
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-1")))) ? { for port in var.oke_vcn1_services_ingress_destination_ports : "EGRESS-TO-OKE-VCN1-ON-${port}-RULE" => {
      description  = "Egress to ${local.oke_vcn1_services_subnet_display_name}."
      stateless    = false
      protocol     = "TCP"
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-2")))) ? { for port in var.oke_vcn2_services_ingress_destination_ports : "EGRESS-TO-OKE-VCN2-ON-${port}-RULE" => {
      description  = "Egress to ${local.oke_vcn2_services_subnet_display_name}."
      stateless    = false
      protocol     = "TCP"
  ...
  oke_vcn_3_to_web_subnet_cross_vcn_egress = merge(
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-1")))) ? { for port in var.tt_vcn1_web_ingress_destination_ports : "EGRESS-TO-TT-VCN1-ON-${port}-RULE" => {
      description  = "Egress to ${local.tt_vcn1_web_subnet_display_name}."
      stateless    = false
      protocol     = "TCP"
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-2")))) ? { for port in var.tt_vcn2_web_ingress_destination_ports : "EGRESS-TO-TT-VCN2-ON-${port}-RULE" => {
      description  = "Egress to ${local.tt_vcn2_web_subnet_display_name}."
      stateless    = false
      protocol     = "TCP"
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-3")))) ? { for port in var.tt_vcn3_web_ingress_destination_ports : "EGRESS-TO-TT-VCN3-ON-${port}-RULE" => {
      description  = "Egress to ${local.tt_vcn3_web_subnet_display_name}."
      stateless    = false
      protocol     = "TCP"
  ...
  oke_vcn_3_to_services_subnet_cross_vcn_ingress = merge(
    ...
    (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? { for cidr_port_pair in flatten([for cidr in var.onprem_cidrs : [for port in var.oke_vcn3_services_ingress_destination_ports : "${trimspace(cidr)},${trimspace(port)}" ]]) : "INGRESS-FROM-${split(",",cidr_port_pair)[0]}-ON-${split(",",cidr_port_pair)[1]}-RULE" => {
      description  = "Ingress from onprem ${split(",",cidr_port_pair)[0]} on TCP port ${split(",",cidr_port_pair)[1]}."
      stateless    = false
      protocol     = "TCP"
      src          = split(",",cidr_port_pair)[0]
      src_type     = "CIDR_BLOCK"
  ...
  oke_vcn_3_to_workers_subnet_cross_vcn_ingress = merge(
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-1")))) ? {
      ...
      "INGRESS-FROM-OKE-VCN-1-SERVICES-SUBNET-RULE" = {
        description  = "Ingress from ${local.oke_vcn1_services_subnet_display_name}."
        stateless    = false
        protocol     = "TCP"
        src          = local.oke_vcn1_services_subnet_cidr
        src_type     = "CIDR_BLOCK"
        dst_port_min = 30000
        dst_port_max = 32767
      }
    ...
    (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-2")))) ? {
      ...
      "INGRESS-FROM-OKE-VCN-2-SERVICES-SUBNET-RULE" = {
        description  = "Ingress from ${local.oke_vcn2_services_subnet_display_name}."
        stateless    = false
        protocol     = "TCP"
        src          = local.oke_vcn2_services_subnet_cidr
        src_type     = "CIDR_BLOCK"
        dst_port_min = 30000
        dst_port_max = 32767
      },
  ...
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-1"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "OKE-VCN-2"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-1"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-2"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "TT-VCN-3"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "EXA-VCN-1"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_exa_vcn2 == true && var.exa_vcn2_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "EXA-VCN-2"))) ? {
  ...
  #   } : {},
  #   (local.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true && var.add_exa_vcn3 == true && var.exa_vcn3_attach_to_drg == true) &&
  #   (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "EXA-VCN-3"))) ? {
