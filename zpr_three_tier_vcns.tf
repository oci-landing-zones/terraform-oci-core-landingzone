  ...
  zpr_configuration = {
    ...
    zpr_policies = {
      ...
      ZPR-POLICY-CROSS-TT1-TT2 = var.add_tt_vcn1 == true && var.add_tt_vcn2 == true ? {
        ...
        statements = [
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn2_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-2-${local.zpr_label} VCN allow ${var.tt_vcn1_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn2_db_subnet_cidr} with protocol='tcp/1521-1522'",
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-2-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn1_db_subnet_cidr} with protocol='tcp/1521-1522'",
        ]
      } : {}
      ZPR-POLICY-CROSS-TT1-TT3 = var.add_tt_vcn1 == true && var.add_tt_vcn3 == true ? {
        ...
        statements = [
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn3_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          ...
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn3_db_subnet_cidr} with protocol='tcp/1521-1522'",
      ...
      ZPR-POLICY-CROSS-TT1-TT3 = var.add_tt_vcn2 == true && var.add_tt_vcn3 == true ? {
        ...
        statements = [
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-2-${local.zpr_label} VCN allow ${var.tt_vcn3_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          ...
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-2-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn3_db_subnet_cidr} with protocol='tcp/1521-1522'",
      ...
      ZPR-POLICY-CROSS-TT1-EXA1 = var.add_tt_vcn1 == true && var.add_exa_vcn1 == true ? {
        ...
        statements = [
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.exa_vcn1_client_subnet_cidr} with protocol='tcp/1521-1522'",
          ...
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn1_db_subnet_cidr} with protocol='tcp/1521-1522'",
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn1_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'"
        ]
      } : {}
