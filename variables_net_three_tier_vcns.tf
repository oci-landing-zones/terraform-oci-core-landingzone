...
variable "tt_vcn1_cidrs" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn1_cidrs variable: all values must be in valid CIDR notation (e.g., 10.0.0.0/20)."
  }
}
...
variable "tt_vcn1_web_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn1_web_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.0.0.0/24)."
  }
}
...
variable "tt_vcn1_app_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn1_app_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.0.0.0/24)."
  }
}
...
variable "tt_vcn1_db_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn1_db_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.0.0.0/24)."
  }
}
...
variable "tt_vcn1_bastion_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn1_bastion_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.0.0.0/24)."
  }
}
...
variable "tt_vcn2_cidrs" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn2_cidrs variable: all values must be in valid CIDR notation (e.g., 10.1.0.0/20)."
  }
}
...
variable "tt_vcn2_web_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn2_web_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.1.0.0/24)."
  }
}
...
variable "tt_vcn2_app_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn2_app_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.1.0.0/24)."
  }
}
...
variable "tt_vcn2_db_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn2_db_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.1.0.0/24)."
  }
}
...
variable "tt_vcn2_bastion_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn2_bastion_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.1.0.0/24)."
  }
}
...
variable "tt_vcn3_cidrs" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn3_cidrs variable: all values must be in valid CIDR notation (e.g., 10.2.0.0/20)."
  }
}
...
variable "tt_vcn3_web_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn3_web_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.2.0.0/24)."
  }
}
...
variable "tt_vcn3_app_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn3_app_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.2.0.0/24)."
  }
}
...
variable "tt_vcn3_db_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn3_db_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.2.0.0/24)."
  }
}
...
variable "tt_vcn3_bastion_subnet_cidr" {
  ...
  validation {
    ...
    error_message = "Invalid value provided for tt_vcn3_bastion_subnet_cidr variable: value must be in valid CIDR notation (e.g., 10.2.0.0/24)."
  }
}
