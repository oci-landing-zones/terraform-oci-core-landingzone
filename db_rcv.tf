locals {
  tt_vcn1_rcv_subnet = var.enable_tt_vcn1_rcv_infra && local.add_tt_vcn1 ? {
    "TT-VCN-1-RCV-SUBNET" = {
      display_name       = "${var.service_label}-three-tier-vcn-1-rcv-subnet"
  ...
  tt_vcn2_rcv_subnet = var.enable_tt_vcn2_rcv_infra && local.add_tt_vcn2 ? {
    "TT-VCN-2-RCV-SUBNET" = {
      display_name       = "${var.service_label}-three-tier-vcn-2-rcv-subnet"
  ...
  tt_vcn3_rcv_subnet = var.enable_tt_vcn3_rcv_infra && local.add_tt_vcn3 ? {
    "TT-VCN-3-RCV-SUBNET" = {
      display_name       = "${var.service_label}-three-tier-vcn-3-rcv-subnet"
  ...
  oke_vcn1_rcv_subnet = var.enable_oke_vcn1_rcv_infra && local.add_oke_vcn1 && var.add_oke_vcn1_db_subnet ? {
    "OKE-VCN-1-RCV-SUBNET" = {
      display_name       = "${var.service_label}-oke-vcn-1-rcv-subnet"
  ...
  oke_vcn2_rcv_subnet = var.enable_oke_vcn2_rcv_infra && local.add_oke_vcn2 && var.add_oke_vcn2_db_subnet ? {
    "OKE-VCN-2-RCV-SUBNET" = {
      display_name       = "${var.service_label}-oke-vcn-2-rcv-subnet"
  ...
  oke_vcn3_rcv_subnet = var.enable_oke_vcn3_rcv_infra && local.add_oke_vcn3 && var.add_oke_vcn3_db_subnet ? {
    "OKE-VCN-3-RCV-SUBNET" = {
      display_name       = "${var.service_label}-oke-vcn-3-rcv-subnet"
  ...
  exa_vcn1_rcv_subnet = var.enable_exa_vcn1_rcv_infra && local.add_exa_vcn1 ? {
    "EXA-VCN-1-SUBNET-RCV" = {
      display_name       = "${var.service_label}-exa-vcn-1-rcv-subnet"
  ...
  exa_vcn2_rcv_subnet = var.enable_exa_vcn2_rcv_infra && local.add_exa_vcn2 ? {
    "EXA-VCN-2-SUBNET-RCV" = {
      display_name       = "${var.service_label}-exa-vcn-2-rcv-subnet"
  ...
  exa_vcn3_rcv_subnet = var.enable_exa_vcn3_rcv_infra && local.add_exa_vcn3 ? {
    "EXA-VCN-3-SUBNET-RCV" = {
      display_name       = "${var.service_label}-exa-vcn-3-rcv-subnet"
  ...
  tt_vcn1_rcv_protection_policy = var.enable_tt_vcn1_rcv_infra && local.add_tt_vcn1 && var.tt_vcn1_rcv_backup_retention_period_in_days > 0? {
    "TT-VCN-1-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-three-tier-vcn-1-rcv-protection-policy"
      backup_retention_period_in_days = var.tt_vcn1_rcv_backup_retention_period_in_days
    }
  } : {}
  tt_vcn2_rcv_protection_policy = var.enable_tt_vcn2_rcv_infra && local.add_tt_vcn2 && var.tt_vcn2_rcv_backup_retention_period_in_days > 0? {
    "TT-VCN-2-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-three-tier-vcn-2-rcv-protection-policy"
      backup_retention_period_in_days = var.tt_vcn2_rcv_backup_retention_period_in_days
    }
  } : {}
  tt_vcn3_rcv_protection_policy = var.enable_tt_vcn3_rcv_infra && local.add_tt_vcn3 && var.tt_vcn3_rcv_backup_retention_period_in_days > 0? {
    "TT-VCN-3-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-three-tier-vcn-3-rcv-protection-policy"
      backup_retention_period_in_days = var.tt_vcn3_rcv_backup_retention_period_in_days
    }
  } : {}
  oke_vcn1_rcv_protection_policy = var.enable_oke_vcn1_rcv_infra && local.add_oke_vcn1 && var.add_oke_vcn1_db_subnet && var.oke_vcn1_rcv_backup_retention_period_in_days > 0? {
    "OKE-VCN-1-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-oke-vcn-1-rcv-protection-policy"
      backup_retention_period_in_days = var.oke_vcn1_rcv_backup_retention_period_in_days
    }
  } : {}
  oke_vcn2_rcv_protection_policy = var.enable_oke_vcn2_rcv_infra && local.add_oke_vcn2 && var.add_oke_vcn2_db_subnet && var.oke_vcn2_rcv_backup_retention_period_in_days > 0? {
    "OKE-VCN-2-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-oke-vcn-2-rcv-protection-policy"
      backup_retention_period_in_days = var.oke_vcn2_rcv_backup_retention_period_in_days
    }
  } : {}
  oke_vcn3_rcv_protection_policy = var.enable_oke_vcn3_rcv_infra && local.add_oke_vcn3 && var.add_oke_vcn3_db_subnet && var.oke_vcn3_rcv_backup_retention_period_in_days > 0? {
    "OKE-VCN-3-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-oke-vcn-3-rcv-protection-policy"
      backup_retention_period_in_days = var.oke_vcn3_rcv_backup_retention_period_in_days
    }
  } : {}
  exa_vcn1_rcv_protection_policy = var.enable_exa_vcn1_rcv_infra && local.add_exa_vcn1 && var.exa_vcn1_rcv_backup_retention_period_in_days > 0? {
    "EXA-VCN-1-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-exa-vcn-1-rcv-protection-policy"
      backup_retention_period_in_days = var.exa_vcn1_rcv_backup_retention_period_in_days
    }
  } : {}
  exa_vcn2_rcv_protection_policy = var.enable_exa_vcn2_rcv_infra && local.add_exa_vcn2 && var.exa_vcn2_rcv_backup_retention_period_in_days > 0? {
    "EXA-VCN-2-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-exa-vcn-2-rcv-protection-policy"
      backup_retention_period_in_days = var.exa_vcn2_rcv_backup_retention_period_in_days
    }
  } : {}
  exa_vcn3_rcv_protection_policy = var.enable_exa_vcn3_rcv_infra && local.add_exa_vcn3 && var.exa_vcn3_rcv_backup_retention_period_in_days > 0? {
    "EXA-VCN-3-RCV-PROTECTION-POLICY" = {
      display_name                    = "${var.service_label}-exa-vcn-3-rcv-protection-policy"
