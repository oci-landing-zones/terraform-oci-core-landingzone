  ...
  tt_3_zpr_policies = merge(
    ...
    var.add_tt_vcn3 && var.add_tt_vcn1 ? {
      ZPR-POLICY-TT-VCN-3-TO-TT-VCN-1 = {
        ...
        name        = "zpr-policy-tt-vcn-3-to-tt-vcn-1-${local.zpr_label}"
        statements = [
    ...
    var.add_tt_vcn3 && var.add_tt_vcn2 ? {
      ZPR-POLICY-TT-VCN-3-TO-TT-VCN-2 = {
        ...
        name        = "zpr-policy-tt-vcn-3-tt-vcn-2-${local.zpr_label}"
        statements = [
    ...
    var.add_tt_vcn3 && var.add_exa_vcn1 ? {
      ZPR-POLICY-TT-VCN-3-TO-EXA-VCN-1 = {
        ...
        name        = "zpr-policy-tt-vcn-3-to-exa-vcn-1-${local.zpr_label}"
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-3-${local.zpr_label} VCN allow '${coalesce(var.exa_vcn1_client_subnet_cidr, cidrsubnet(var.exa_vcn1_cidrs[0], 4, 2))}' to connect to '${coalesce(var.tt_vcn3_db_subnet_cidr, cidrsubnet(var.tt_vcn3_cidrs[0], 4, 2))}' with protocol='tcp/1521-1522'"
        ]
      }
    } : {},
    ...
    var.add_tt_vcn3 && var.add_exa_vcn2 ? {
      ZPR-POLICY-TT-VCN-3-TO-EXA-VCN-2 = {
        ...
        name        = "zpr-policy-tt-vcn-3-to-exa-vcn-2-${local.zpr_label}"
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-3-${local.zpr_label} VCN allow '${coalesce(var.exa_vcn2_client_subnet_cidr, cidrsubnet(var.exa_vcn2_cidrs[0], 4, 2))}' to connect to '${coalesce(var.tt_vcn3_db_subnet_cidr, cidrsubnet(var.tt_vcn3_cidrs[0], 4, 2))}' with protocol='tcp/1521-1522'"
        ]
      }
    } : {},
    ...
    var.add_tt_vcn3 && var.add_exa_vcn3 ? {
      ZPR-POLICY-TT-VCN-3-TO-EXA-VCN-3 = {
        ...
        name        = "zpr-policy-tt-vcn-3-to-exa-vcn-3-${local.zpr_label}"
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:tt-vcn-3-${local.zpr_label} VCN allow '${coalesce(var.exa_vcn3_client_subnet_cidr, cidrsubnet(var.exa_vcn3_cidrs[0], 4, 2))}' to connect to '${coalesce(var.tt_vcn3_db_subnet_cidr, cidrsubnet(var.tt_vcn3_cidrs[0], 4, 2))}' with protocol='tcp/1521-1522'"
        ]
      }
    } : {}
  )
