locals {
  ...
  tt_3_to_tt_1_policies = var.add_tt_vcn1 ? [
  ...
  tt_3_to_tt_2_policies = var.add_tt_vcn2 ? [
  ...
  tt_3_to_exa_1_policies = var.add_exa_vcn1 ? [
  ...
  tt_3_to_exa_2_policies = var.add_exa_vcn2 ? [
  ...
  tt_3_to_exa_3_policies = var.add_exa_vcn3 ? [
