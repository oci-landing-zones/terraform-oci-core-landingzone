...
locals {
        ...
        var.deploy_bastion_jump_host == true ? {
          "JUMPHOST-SUBNET-ROUTE-TABLE" = {
            ...
            route_rules = merge(
              ...
              local.hub_vcn_jumphost_drg_routing
            )
          }
        } : {},
        ...
        local.chosen_firewall_option != "OCINFW" ? {
          "HUB-VCN-MGMT-NSG" = {
            ...
            ingress_rules = merge(
              ...
              # var.deploy_bastion_service == true ?
              # {
        ...
        var.deploy_bastion_jump_host == true ? {
          "HUB-VCN-JUMP-HOST-NSG" = {
            ...
            ingress_rules = merge(
              {
                for cidr in var.bastion_onprem_ssh_allowed_cidrs : "INGRESS-FROM-${cidr}-RULE" => {
                  ...
                  dst_port_min = 22,
                  dst_port_max = 22
                } if length(var.bastion_onprem_ssh_allowed_cidrs) > 0
              },
              {
            ...
            egress_rules = merge(
              ...
              local.hub_vcn_to_app_subnet_cross_vcn_egress,
              local.hub_vcn_to_db_subnet_cross_vcn_egress,
              local.hub_vcn_to_oke_cross_vcn_egress,
              local.hub_vcn_to_exa_cross_vcn_egress
  ...
  ## Jump Host Subnet Routing Cross VCNs
  hub_vcn_jumphost_drg_routing = merge(
    ## Route to TT-VCN-1
  ...
  hub_vcn_to_app_subnet_cross_vcn_egress = merge(
    local.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true && local.hub_with_vcn == true && local.chosen_firewall_option == "NO" ? {
  ...
  hub_vcn_to_db_subnet_cross_vcn_egress = merge(
    local.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true && local.hub_with_vcn == true && local.chosen_firewall_option == "NO" ? {
  ...
  hub_vcn_to_oke_cross_vcn_egress = merge(
    var.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true && local.hub_with_vcn == true && local.chosen_firewall_option == "NO" ? {
  ...
  hub_vcn_to_exa_cross_vcn_egress = merge(
    var.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && local.hub_with_vcn == true && local.chosen_firewall_option == "NO" ? {
