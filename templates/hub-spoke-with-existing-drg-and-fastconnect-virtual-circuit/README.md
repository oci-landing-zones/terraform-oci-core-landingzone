...
|---------------|-------------|-------|
| service\_label | A unique identifier to prefix the resources | "fc" |
...
| onprem\_cidrs | List of on-premises CIDR blocks allowed to connect to the Landing Zone network via a DRG. | [10.0.0.0/16"] |
...
| tt\_vcn1\_cidrs | Three-tier VCN 1 CIDR blocks. | ["172.16.0.0/24"] |
...
| exa\_vcn1\_cidrs | Exa VCN 1 CIDR blocks. | ["172.16.1.0/24"] |
