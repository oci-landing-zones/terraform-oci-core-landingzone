...
| custom\_id\_domain\_ocid | Replace with your identity domain OCID. | "ocid1.domain.oc1..replace-with-your-identity-domain-ocid" |
| deploy\_custom\_domain\_groups | Deploy custom identity domain groups and dynamic groups. | true |
| customize\_iam | RMS UI control to show/hide Landing Zone customization options. Ignored by during plan/apply. | true |
