  ...
  exa_zpr_policies = merge(
    var.add_exa_vcn1 ? {
      ZPR-POLICY-EXA-VCN-1 = {
        ...
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints with protocol='tcp/22,1521-1522,6200'"
        ]
      }
    } : {},
    ...
    var.add_exa_vcn2 ? {
      ZPR-POLICY-EXA-VCN-2 = {
        ...
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-2-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints with protocol='tcp/22,1521-1522,6200'"
        ]
      }
    } : {},
    ...
    var.add_exa_vcn3 ? {
      ZPR-POLICY-EXA-VCN-2 = {
        ...
        statements = [
          ...
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-3-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints with protocol='tcp/22,1521-1522,6200'"
        ]
      }
    } : {},
    ((var.add_exa_vcn3) && (local.hub_with_vcn == true) && (var.exa_vcn3_attach_to_drg == true)) ? {
      ZPR-POLICY-EXA-VCN-2-HUB = {
        description = "zpr policy for exa vcn 3 to hub vcn cidrs"
        name        = "zpr-policy-exa-vcn-3-hub"
        statements = [
          for cidr in var.hub_vcn_cidrs :
    ...
    var.add_exa_vcn1 && var.add_tt_vcn2 ? {
      ZPR-POLICY-EXA-VCN-1-TO-TT-VCN-2 = {
        ...
        statements = [
          // Allow endpoints in Client subnet of Exadata VCN to communicate with other endpoints in the TT VCNs
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn2_db_subnet_cidr} with protocol='tcp/1521-1522'",
          // Allow DB Server to communicate with other endpoints in the TT VCNs
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn2_db_subnet_cidr} with protocol='tcp/1521-1522'",
          // Allow App and DB Subnet endpoints in Three Tier VCNs connect to Client Subnet in Exadata / Ingress
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn2_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          // Allow App and DB Subnet endpoints in Three Tier VCNs connect to DB Subnet in Exadata / Ingress
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn2_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'"
        ]
      }
    ...
    var.add_exa_vcn1 && var.add_tt_vcn3 ? {
      ZPR-POLICY-EXA-VCN-1-TO-TT-VCN-3 = {
        ...
        statements = [
          // Allow endpoints in Client subnet of Exadata VCN to communicate with other endpoints in the TT VCNs
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn3_db_subnet_cidr} with protocol='tcp/1521-1522'",
          // Allow DB Server to communicate with other endpoints in the TT VCNs
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} endpoints to connect to ${var.tt_vcn3_db_subnet_cidr} with protocol='tcp/1521-1522'",
          // Allow App and DB Subnet endpoints in Three Tier VCNs connect to Client Subnet in Exadata / Ingress
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn3_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'",
          // Allow App and DB Subnet endpoints in Three Tier VCNs connect to DB Subnet in Exadata / Ingress
          "in ${var.zpr_security_attributes_namespace}.net:exa-vcn-1-${local.zpr_label} VCN allow ${var.tt_vcn3_db_subnet_cidr} endpoints to connect to ${var.zpr_security_attributes_namespace}.database:${local.zpr_label} with protocol='tcp/1521-1522'"
        ]
      }
