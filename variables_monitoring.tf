...
variable "network_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for network_admin_email_endpoints: at least one valid email address must be provided."
  }
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for network_admin_email_endpoints: invalid email address."
  }
}
variable "security_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for security_admin_email_endpoints: at least one valid email address must be provided."
  }
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for security_admin_email_endpoints: invalid email address."
  }
}
variable "storage_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for storage_admin_email_endpoints: invalid email address."
  }
}
variable "compute_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for compute_admin_email_endpoints: invalid email address."
  }
}
variable "budget_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for budget_admin_email_endpoints: invalid email address."
  }
}
variable "database_admin_email_endpoints" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for database_admin_email_endpoints: invalid email address."
  }
}
...
variable "alarm_message_format" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for alarm_message_format: valid values (case insensitive) are PRETTY_JSON, RAW, or ONS_OPTIMIZED."
  }
}
...
variable "service_connector_target_kind" {
  ...
  validation {
    ...
    error_message = "VALIDATION FAILURE: Validation failed for service_connector_target_kind: valid values are objectstorage, streaming, functions or logginganalytics."
  }
}
