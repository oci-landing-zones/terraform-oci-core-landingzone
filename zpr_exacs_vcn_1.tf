locals {
  ...
  exa_1_to_exa_2_policies = var.add_exa_vcn1 && var.add_exa_vcn2 ? [
  ...
  exa_1_to_exa_3_policies = var.add_exa_vcn1 && var.add_exa_vcn3 ? [
  ...
  exa_1_to_tt_1_policies = var.add_exa_vcn1 && var.add_tt_vcn1 ? [
  ...
  exa_1_to_tt_2_policies = var.add_exa_vcn1 && var.add_tt_vcn2 ? [
  ...
  exa_1_to_tt_3_policies = var.add_exa_vcn1 && var.add_tt_vcn3 ? [
  ...
  exa_vcn_1_zpr_policies = var.add_exa_vcn1 ? {
