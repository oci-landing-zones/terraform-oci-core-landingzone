...
locals {
  ...
  exa_vcn2_cross_vcn_integration_nsg_ingress_security_rules = (
    (var.exa_vcn2_onprem_route_enable == true) && (local.hub_with_vcn == true || local.hub_with_drg_only == true)
  ) ? local.exa_vcn_2_integration_subnet_ingress_from_onprem_security_rules : {}
}
