...
locals {
      ...
      network_security_groups = {
        "EXA-VCN-1-CLIENT-NSG" = {
          ...
          ingress_rules = merge(
            ...
            local.exa_vcn_1_to_onprem_ipsec_ingress,
            local.exa_vcn_1_to_onprem_fc_ingress,
          )
          egress_rules = merge(
            {
              "EGRESS-TO-SSH-RULE" = {
            ...
            local.exa_vcn_1_to_onprem_ipsec_egress,
            local.exa_vcn_1_to_onprem_fc_egress,
          )
        }
  ...
  exa_vcn_1_to_pods_subnet_cross_vcn_egress = merge(
    ...
    exa_vcn_1_to_onprem_ipsec_egress = merge(
    (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && length(var.onprem_cidrs) > 0) &&
    (local.hub_with_drg_only == true) && ((var.on_premises_connection_option == "IPSec VPN") || (var.on_premises_connection_option == "FastConnect and IPSec")) && (length(var.exa_vcn1_routable_vcns) != 0) && (contains(var.exa_vcn1_routable_vcns, "OnPremVPN")) ? merge(
      {
    ...
    exa_vcn_1_to_onprem_fc_egress = merge(
    (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && length(var.onprem_cidrs) > 0) &&
    (local.hub_with_drg_only == true) && ((var.on_premises_connection_option == "FastConnect Virtual Circuit") || (var.on_premises_connection_option == "FastConnect and IPSec")) && (length(var.exa_vcn1_routable_vcns) != 0) && (contains(var.exa_vcn1_routable_vcns, "OnPremFC")) ? merge(
      {
  ...
  exa_vcn_1_to_client_subnet_cross_vcn_ingress = merge(
    ...
    exa_vcn_1_to_onprem_ipsec_ingress = merge(
    (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && length(var.onprem_cidrs) > 0) &&
    (local.hub_with_drg_only == true) && ((var.on_premises_connection_option == "IPSec VPN") || (var.on_premises_connection_option == "FastConnect and IPSec")) && (length(var.exa_vcn1_routable_vcns) != 0) && (contains(var.exa_vcn1_routable_vcns, "OnPremVPN")) ? merge(
      {
    ...
    exa_vcn_1_to_onprem_fc_ingress = merge(
    (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && length(var.onprem_cidrs) > 0) &&
    (local.hub_with_drg_only == true) && ((var.on_premises_connection_option == "FastConnect Virtual Circuit") || (var.on_premises_connection_option == "FastConnect and IPSec")) && (length(var.exa_vcn1_routable_vcns) != 0) && (contains(var.exa_vcn1_routable_vcns, "OnPremFC")) ? merge(
      {
