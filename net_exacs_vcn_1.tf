...
locals {
  ...
  add_exa_vcn1_backup_subnet      = local.add_exa_vcn1 == true && var.add_exa_vcn1_backup_subnet == true
  ...
  exa_vcn1_private_endpoint_subnet_display_name                  = coalesce(var.exa_vcn1_private_endpoint_subnet_name, "${var.service_label}-exadata-vcn-1-private-endpoint-subnet")
  exa_vcn1_private_endpoint_subnet_dns_label                     = substr(replace(coalesce(var.exa_vcn1_private_endpoint_subnet_name, "pe-subnet"), "/[^\\w]/", ""), 0, 14)
  exa_vcn1_private_endpoint_subnet_cidr                          = coalesce(var.exa_vcn1_private_endpoint_subnet_cidr, try(cidrsubnet(var.exa_vcn1_cidrs[0], 28 - tonumber(split("/", var.exa_vcn1_cidrs[0])[1]), pow(2, 28 - tonumber(split("/", var.exa_vcn1_cidrs[0])[1])) - 1), null))
  ...
  exa_vcn_1 = local.add_exa_vcn1 == true ? {
    "EXA-VCN-1" = {
      enable_cis_checks                = local.vcn_cis_checks_override_allowed ? local.exa_vcn1_cis_checks_enabled : true
      ...
      subnets = merge(
        ...
        local.add_exa_vcn1_backup_subnet == true ? {
          "EXA-VCN-1-BACKUP-SUBNET" = {
            ...
            security_list_keys        = local.exa_vcn1_backup_subnet_security_list != null ? ["EXA-VCN-1-BACKUP-SUBNET-SL"] : []
          }
        } : {},
        local.add_exa_vcn1_integration_subnet == true ? {
          "EXA-VCN-1-INTEGRATION-SUBNET" = {
            ...
            security_list_keys        = local.exa_vcn1_integration_subnet_security_list != null ? ["EXA-VCN-1-INTEGRATION-SUBNET-SL"] : []
          }
        } : {},
        var.add_exa_vcn1_private_endpoint_subnet == true ? {
          "EXA-VCN-1-PRIVATE-ENDPOINT-SUBNET" = {
            cidr_block                 = local.exa_vcn1_private_endpoint_subnet_cidr
            dhcp_options_key           = "default_dhcp_options"
            display_name               = local.exa_vcn1_private_endpoint_subnet_display_name
            dns_label                  = local.exa_vcn1_private_endpoint_subnet_dns_label
            ipv6cidr_blocks            = []
            prohibit_internet_ingress  = true
            prohibit_public_ip_on_vnic = true
            route_table_key            = "EXA-VCN-1-PRIVATE-ENDPOINT-ROUTE-TABLE"
            security_list_keys         = local.exa_vcn1_private_endpoint_subnet_security_list != null ? ["EXA-VCN-1-PRIVATE-ENDPOINT-SL"] : []
          }
        } : {}
      )
      ...
      route_tables = merge(
        ...
        var.add_exa_vcn1_private_endpoint_subnet == true ? {
          "EXA-VCN-1-PRIVATE-ENDPOINT-ROUTE-TABLE" = {
            display_name = "private-endpoint-route-table"
            route_rules = merge(
              local.exa_vcn1_enable_intra_vcn_drg_route && var.exa_vcn1_attach_to_drg ? {
                "CLIENT-SUBNET-RULE" = {
                  network_entity_key = "HUB-DRG"
              ...
              local.exa_vcn1_private_endpoint_subnet_additional_route_rules
            )
          }
        } : {}
      )
      ...
      security_lists = merge(
        ...
        local.exa_vcn1_client_subnet_security_list != null ? {
          "EXA-VCN-1-CLIENT-SUBNET-SL" = local.exa_vcn1_client_subnet_security_list
        } : {},
        local.exa_vcn1_backup_subnet_security_list != null && local.add_exa_vcn1_backup_subnet == true ? {
          "EXA-VCN-1-BACKUP-SUBNET-SL" = local.exa_vcn1_backup_subnet_security_list
        } : {},
        local.exa_vcn1_integration_subnet_security_list != null && local.add_exa_vcn1_integration_subnet == true ? {
          "EXA-VCN-1-INTEGRATION-SUBNET-SL" = local.exa_vcn1_integration_subnet_security_list
        } : {},
        var.add_exa_vcn1_private_endpoint_subnet && local.exa_vcn1_private_endpoint_subnet_security_list != null ? {
          "EXA-VCN-1-PRIVATE-ENDPOINT-SL" = local.exa_vcn1_private_endpoint_subnet_security_list
        } : {}
      )
      ...
      network_security_groups = merge(
        {
          "EXA-VCN-1-CLIENT-NSG" = {
            ...
            ingress_rules = merge(
              { for port in var.exa_vcn1_client_ingress_destination_ports : "INGRESS-FROM-AIDP-NSG-ON-${port}-RULE" => {
              ...
              } if var.enable_aidp_infra == true && local.add_exa_vcn1_integration_subnet == true },
        ...
        var.enable_generative_ai_infra == true ? {
          "EXA-VCN-1-GEN-AI-NSG" = {
            display_name = "gen-ai-nsg"
            ingress_rules = var.add_exa_vcn1_private_endpoint_subnet ? {
            ...
            egress_rules = var.add_exa_vcn1_private_endpoint_subnet ? {} : {
              "EGRESS-TO-OSN-HTTPS" = {
        ...
        var.enable_aidp_infra == true && local.add_exa_vcn1_integration_subnet == true ? {
          "EXA-VCN-1-AIDP-NSG" = {
            display_name = "aidp-nsg"
            ingress_rules = merge(
              var.add_exa_vcn1_private_endpoint_subnet ? merge(
                {
              ...
              local.exa_vcn1_aidp_nsg_additional_ingress_rules
            )
            egress_rules = merge(
              var.add_exa_vcn1_private_endpoint_subnet ? {} : {
                "EGRESS-TO-OSN-HTTPS" = {
              ...
              local.exa_vcn1_aidp_nsg_additional_egress_rules
            )
          }
        } : {},
        ...
        local.additional_nsgs_by_vcn["EXA-VCN-1"]
      )
  ...
  exa_vcn_1_drg_routing = (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true) ? merge(
    length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-1") ? local.tt_vcn1_route_rule : {},
    length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-2") ? local.tt_vcn2_route_rule : {},
    length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-3") ? local.tt_vcn3_route_rule : {},
    length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-1") ? local.oke_vcn1_route_rule : {},
    length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-2") ? local.oke_vcn2_route_rule : {},
  ...
  # Cross VCN Open NSG
  #-------------------------------------------------------------
  exa_vcn1_cross_vcn_open_nsg = (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && local.cross_vcn_open_nsg_enabled == true) ? {
  ...
  exa_vcn1_cross_vcn_open_nsg_ingress_security_rules = merge(
    (local.hub_with_vcn == true) ? local.from_hub_vcn_ingress_security_rules : {},
    (var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn1_routable_vcns) == 0 || contains(var.tt_vcn1_routable_vcns, "EXA-VCN-1")))) ? local.from_tt_vcn_1_ingress_security_rules : {},
    (var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn2_routable_vcns) == 0 || contains(var.tt_vcn2_routable_vcns, "EXA-VCN-1")))) ? local.from_tt_vcn_2_ingress_security_rules : {},
    (var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn3_routable_vcns) == 0 || contains(var.tt_vcn3_routable_vcns, "EXA-VCN-1")))) ? local.from_tt_vcn_3_ingress_security_rules : {},
    (var.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "EXA-VCN-1")))) ? local.from_oke_vcn_1_ingress_security_rules : {},
    (var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn2_routable_vcns) == 0 || contains(var.oke_vcn2_routable_vcns, "EXA-VCN-1")))) ? local.from_oke_vcn_2_ingress_security_rules : {},
    (var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "EXA-VCN-1")))) ? local.from_oke_vcn_3_ingress_security_rules : {},
    (var.add_exa_vcn2 == true && var.exa_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn2_routable_vcns) == 0 || contains(var.exa_vcn2_routable_vcns, "EXA-VCN-1")))) ? local.from_exa_vcn_2_ingress_security_rules : {},
    (var.add_exa_vcn3 == true && var.exa_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn3_routable_vcns) == 0 || contains(var.exa_vcn3_routable_vcns, "EXA-VCN-1")))) ? local.from_exa_vcn_3_ingress_security_rules : {},
    (var.exa_vcn1_onprem_route_enable == true) && (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? local.from_onprem_ingress_security_rules : {}
  )

  exa_vcn1_cross_vcn_open_nsg_egress_security_rules = merge(
    (local.hub_with_vcn == true) ? local.to_hub_vcn_egress_security_rules : {},
    (var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-1")))) ? local.to_tt_vcn_1_egress_security_rules : {},
    (var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-2")))) ? local.to_tt_vcn_2_egress_security_rules : {},
    (var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-3")))) ? local.to_tt_vcn_3_egress_security_rules : {},
    (var.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-1")))) ? local.to_oke_vcn_1_egress_security_rules : {},
    (var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-2")))) ? local.to_oke_vcn_2_egress_security_rules : {},
    (var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-3")))) ? local.to_oke_vcn_3_egress_security_rules : {},
    (var.add_exa_vcn2 == true && var.exa_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "EXA-VCN-2")))) ? local.to_exa_vcn_2_egress_security_rules : {},
    (var.add_exa_vcn3 == true && var.exa_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "EXA-VCN-3")))) ? local.to_exa_vcn_3_egress_security_rules : {},
    (var.exa_vcn1_onprem_route_enable == true) && (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? local.to_onprem_egress_security_rules : {}
  )

  #-------------------------------------------------------------
  # Cross VCN Constrained NSG
  #-------------------------------------------------------------
  exa_vcn1_cross_vcn_client_nsg = (local.add_exa_vcn1 == true && var.exa_vcn1_attach_to_drg == true && var.enable_cross_vcn_constrained_nsgs == true && (length(local.exa_vcn1_cross_vcn_client_nsg_ingress_security_rules) > 0 || length(local.exa_vcn1_cross_vcn_client_nsg_egress_security_rules) > 0)) ? {
  ...
  exa_vcn1_cross_vcn_client_nsg_ingress_security_rules = merge(
    (var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn1_routable_vcns) == 0 || contains(var.tt_vcn1_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_tt_vcn1_app_security_rules, local.exa_vcn_1_client_subnet_ingress_from_tt_vcn1_db_security_rules) : {},
    (var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn2_routable_vcns) == 0 || contains(var.tt_vcn2_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_tt_vcn2_app_security_rules, local.exa_vcn_1_client_subnet_ingress_from_tt_vcn2_db_security_rules) : {},
    (var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.tt_vcn3_routable_vcns) == 0 || contains(var.tt_vcn3_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_tt_vcn3_app_security_rules, local.exa_vcn_1_client_subnet_ingress_from_tt_vcn3_db_security_rules) : {},
    (var.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn1_routable_vcns) == 0 || contains(var.oke_vcn1_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_oke_vcn1_workers_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn1_pods_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn1_db_security_rules) : {},
    (var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn2_routable_vcns) == 0 || contains(var.oke_vcn2_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_oke_vcn2_workers_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn2_pods_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn2_db_security_rules) : {},
    (var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.oke_vcn3_routable_vcns) == 0 || contains(var.oke_vcn3_routable_vcns, "EXA-VCN-1")))) ? merge(local.exa_vcn_1_client_subnet_ingress_from_oke_vcn3_workers_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn3_pods_security_rules, local.exa_vcn_1_client_subnet_ingress_from_oke_vcn3_db_security_rules) : {},
    (var.add_exa_vcn2 == true && var.exa_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn2_routable_vcns) == 0 || contains(var.exa_vcn2_routable_vcns, "EXA-VCN-1")))) ? local.exa_vcn_1_client_subnet_ingress_from_exa_vcn2_security_rules : {},
    (var.add_exa_vcn3 == true && var.exa_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn3_routable_vcns) == 0 || contains(var.exa_vcn3_routable_vcns, "EXA-VCN-1")))) ? local.exa_vcn_1_client_subnet_ingress_from_exa_vcn3_security_rules : {},
    (var.exa_vcn1_onprem_route_enable == true) && (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? local.exa_vcn_1_client_subnet_ingress_from_onprem_security_rules : {}
  )

  exa_vcn1_cross_vcn_client_nsg_egress_security_rules = merge(
    (var.add_tt_vcn1 == true && var.tt_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-1")))) ? local.tt_vcn_1_db_subnet_egress_security_rules : {},
    (var.add_tt_vcn2 == true && var.tt_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-2")))) ? local.tt_vcn_2_db_subnet_egress_security_rules : {},
    (var.add_tt_vcn3 == true && var.tt_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "TT-VCN-3")))) ? local.tt_vcn_3_db_subnet_egress_security_rules : {},
    (var.add_oke_vcn1 == true && var.oke_vcn1_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-1")))) ? local.oke_vcn_1_db_subnet_egress_security_rules : {},
    (var.add_oke_vcn2 == true && var.oke_vcn2_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-2")))) ? local.oke_vcn_2_db_subnet_egress_security_rules : {},
    (var.add_oke_vcn3 == true && var.oke_vcn3_attach_to_drg == true) && (local.hub_with_vcn == true || (local.hub_with_drg_only == true && (length(var.exa_vcn1_routable_vcns) == 0 || contains(var.exa_vcn1_routable_vcns, "OKE-VCN-3")))) ? local.oke_vcn_3_db_subnet_egress_security_rules : {},
  ...
  exa_vcn1_cross_vcn_integration_nsg_ingress_security_rules = (var.exa_vcn1_onprem_route_enable == true) && (local.hub_with_vcn == true || local.hub_with_drg_only == true) ? local.exa_vcn_1_integration_subnet_ingress_from_onprem_security_rules : {}
}
