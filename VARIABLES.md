...
| hub_vcn_deploy_firewall_option | The firewall option for deploying in the Hub VCN. Valid values: 'Don't deploy any network appliance at this time.' (default), 'Palo Alto Networks VM-Series Firewall', 'Fortinet FortiGate Firewall'. Costs are incurred. | `string` | `Don't deploy any network appliance at this time.` | Don't deploy any network appliance at this time. |
