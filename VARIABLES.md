...
| tt\_vcn2\_routable\_vcns | The VCN labels that this VCN can send traffic to. Only applicable for Hub/Spoke topology where a DRG is deployed as the hub. Valid values: "TT-VCN-1", "TT-VCN-3", "EXA-VCN-1", "EXA-VCN-2", "EXA-VCN-3", "OKE-VCN-1", "OKE-VCN-2", "OKE-VCN-3". | list(string) | [] | no |
...
| tt\_vcn3\_routable\_vcns | The VCN labels that this VCN can send traffic to. Only applicable for Hub/Spoke topology where a DRG is deployed as the hub. Valid values: "TT-VCN-1", "TT-VCN-2", "EXA-VCN-1", "EXA-VCN-2", "EXA-VCN-3", "OKE-VCN-1", "OKE-VCN-2", "OKE-VCN-3". | list(string) | [] | no |
...
| oke\_vcn1\_routable\_vcns | The VCN labels that this VCN can send traffic to. Only applicable for Hub/Spoke topology where a DRG is deployed as the hub. Valid values: "TT-VCN-1", "TT-VCN-2", "TT-VCN-3", "EXA-VCN-1", "EXA-VCN-2", "EXA-VCN-3", "OKE-VCN-2", "OKE-VCN-3". | list(string) | [] | no |
...
| oke\_vcn2\_routable\_vcns | The VCN labels that this VCN can send traffic to. Only applicable for Hub/Spoke topology where a DRG is deployed as the hub. Valid values: "TT-VCN-1", "TT-VCN-2", "TT-VCN-3", "EXA-VCN-1", "EXA-VCN-2", "EXA-VCN-3", "OKE-VCN-1", "OKE-VCN-3". | list(string) | [] | no |
...
| oke\_vcn3\_routable\_vcns | The VCN labels that this VCN can send traffic to. Only applicable for Hub/Spoke topology where a DRG is deployed as the hub. Valid values: "TT-VCN-1", "TT-VCN-2", "TT-VCN-3", "EXA-VCN-1", "EXA-VCN-2", "EXA-VCN-3", "OKE-VCN-1", "OKE-VCN-2". | list(string) | [] | no |
...
| tt\_vcn1\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in TT-VCN-1 db subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| tt\_vcn2\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in TT-VCN-2 db subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| tt\_vcn3\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in TT-VCN-3 db subnet. You must enter a value greater than 0 to enable the policy.| number | 0 | no |
...
| oke\_vcn1\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in OKE-VCN-1 db subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| oke\_vcn2\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in OKE-VCN-2 db subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| oke\_vcn3\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in OKE-VCN-3 db subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| exa\_vcn1\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in EXA-VCN-1 backup (if provided) or client subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| exa\_vcn2\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in EXA-VCN-2 backup (if provided) or client subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| exa\_vcn3\_rcv\_backup\_retention\_period\_in\_days | The number of days to retain backup data in the Autonomous Recovery Service for databases in EXA-VCN-3 backup (if provided) or client subnet. You must enter a value greater than 0 to enable the policy. | number | 0 | no |
...
| enable\_cross\_vcn\_constrained\_nsgs | When true, Landing Zone provisions constrained NSGs that enable DRG-attached and routable VCNs to connect according to Landing Zone provided rules. Enabled by default. For migration to open cross-VCN NSGs, first enable enable\_cross\_vcn\_open\_nsg while keeping this true, then disable this in a second apply. | bool | true | no |
| enable\_cross\_vcn\_open\_nsg | When true, Landing Zone provisions an open NSG that enables DRG-attached and routable VCNs to fully connect. Open and constrained cross-VCN NSGs can coexist to support a two-apply migration. For Hub VCN, the open NSG is created when requested and left unattached by default. | bool | false | no |
...
| hub\_vcn\_external\_allowed\_cidrs\_into\_web\_tier | The list of external CIDR blocks allowed for ingress packets into the Hub VCN App Load Balancer NSG. Effective only when hub\_vcn\_web\_subnet\_is\_private is false. Use this to limit the range of IP addresses that can access the Hub VCN web tier. | list(string) | ["0.0.0.0/0"] | no |
